...
|-------------|------|-------------|
| **Shashank Saha** | Project Lead & Developer | CDC × Yhills Open Projects (2025-26) |
...
```bash
# 1. Clone repository
git clone https://github.com/ShashankSaha27/Agentic-Al-Based-Dynamic-Tariff-Optimization-for-EV-Charging-Networks.git
cd Agentic Al-Based Dynamic Tariff Optimization for EV Charging Networks
